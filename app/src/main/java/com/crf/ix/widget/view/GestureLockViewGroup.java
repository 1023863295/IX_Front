...
public class GestureLockViewGroup extends RelativeLayout
{
                                ...
                                int defStyle)
    {
        ...
        mPaint.setStrokeJoin(Paint.Join.BEVEL); //设置结合处的样子，Miter:结合处为锐角， Round:结合处为圆弧：BEVEL：结合处为直线。
...
//            mGestureLockViewWidth = (int) (4 * mWidth * 1.0f / (5 * mCount + 1));
            mGestureLockViewWidth = (int) (2 * mWidth * 1.0f / (3 * mCount+2));
