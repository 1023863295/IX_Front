...
import com.crf.ix.http.cache.SetCookieCache;
import com.crf.ix.http.persistence.SharedPrefsCookiePersistor;
...
/**
 * @ClassName: BaseApiRetrofit
 * @Description: java类描述
 * @Author: liuliang
 * @CreateDate: 2018/9/3 9:40
 */
...
//        loggingInterceptor.setLevel(HttpLoggingInterceptor.Level.NONE);//这里可以选择拦截级别
        ...
        //cache
        File httpCacheDir = new File(MyApplication.getAppContext().getCacheDir(), "response");
